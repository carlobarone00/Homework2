...
def generate_launch_description():
    ...
    """declared_arguments.append(DeclareLaunchArgument('gz_args', default_value='-r -v 1 iiwa_personal_world.sdf',
                              description='Arguments for gz_sim'),)"""
        
    iiwa_world_path = get_package_share_directory('iiwa_description') + '/gazebo/worlds/iiwa_personal_world.world'
